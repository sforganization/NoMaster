	   ...
	   case CMD_UPDATE:
		   if(*(data + 2) ==  0xFF)   //该全部手表
		   {
			   for(i = 0 ; i < GLASS_MAX_CNT; i++)
			   {
				   ...
				   //SysTask.LockMode[i]		  =  *(data + 5);  //锁状态不在此更新，因为开锁需要密?
   ??之后
		   ...
		   else  //单个手表的状态更新
		   {
			  ...
			  // SysTask.LockMode[*(data + 2)]		=  *(data + 5);//锁状态不在此更新，因为开锁需要
   密码之后
		   }	  
	...
	switch (SysTask.Lock_State[GLASS_01]) //_01锁
	{
		...
		case LOCK_STATE_DEBOUNSE: //消抖 40ms 到达中点再开锁
			if (SysTask.Lock_StateTime[GLASS_01] == 0)
			{
				if (GPIO_ReadInputDataBit(LOCK_ZERO_GPIO, LOCK_ZERO_01_PIN) == 0) //检测到零点 开锁
				{
					GPIO_ResetBits(LOCK_GPIO, LOCK_01_PIN); //上电，另一边单片机会自己开锁逻辑
...
void Lock_04_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_04]) //_04锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_04] != SysTask.LockModeSave[GLASS_04])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_04] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_04] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_04_PIN);
					SysTask.Lock_StateTime[GLASS_04] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_04] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_04_PIN);
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_04] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_05_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_05]) //_05锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_05] != SysTask.LockModeSave[GLASS_05])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_05] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_05] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_05_PIN);
					SysTask.Lock_StateTime[GLASS_05] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_05] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_05_PIN);
				SysTask.Lock_StateTime[GLASS_05] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_05] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_06_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_06]) //_06锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_06] != SysTask.LockModeSave[GLASS_06])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_06] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_06] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_06_PIN);
					SysTask.Lock_StateTime[GLASS_06] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_06] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_06_PIN);
				SysTask.Lock_StateTime[GLASS_06] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_06] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_07_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_07]) //_07锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_07] != SysTask.LockModeSave[GLASS_07])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_07] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_07] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_07_PIN);
					SysTask.Lock_StateTime[GLASS_07] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_07] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_07_PIN);
				SysTask.Lock_StateTime[GLASS_07] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_07] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_08_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_08]) //_08锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_08] != SysTask.LockModeSave[GLASS_08])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_08] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_08] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_08_PIN);
					SysTask.Lock_StateTime[GLASS_08] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_08] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_08_PIN);
				SysTask.Lock_StateTime[GLASS_08] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_08] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_09_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_09]) //_09锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_09] != SysTask.LockModeSave[GLASS_09])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_09] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_09] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_09_PIN);
					SysTask.Lock_StateTime[GLASS_09] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_09] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_09_PIN);
				SysTask.Lock_StateTime[GLASS_09] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_09] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_10_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_10]) //_10锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_10] != SysTask.LockModeSave[GLASS_10])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_10] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_10] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_10_PIN);
					SysTask.Lock_StateTime[GLASS_10] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_10] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_10_PIN);
				SysTask.Lock_StateTime[GLASS_10] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_10] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_11_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_11]) //_11锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_11] != SysTask.LockModeSave[GLASS_11])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_11] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_11] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_11_PIN);
					SysTask.Lock_StateTime[GLASS_11] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_11] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_11_PIN);
				SysTask.Lock_StateTime[GLASS_11] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_11] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_12_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_12]) //_12锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_12] != SysTask.LockModeSave[GLASS_12])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_12] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_12] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_12_PIN);
					SysTask.Lock_StateTime[GLASS_12] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_12] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_12_PIN);
				SysTask.Lock_StateTime[GLASS_12] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_12] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_13_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_13]) //_13锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_13] != SysTask.LockModeSave[GLASS_13])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_13] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_13] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_13_PIN);
					SysTask.Lock_StateTime[GLASS_13] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_13] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_13_PIN);
				SysTask.Lock_StateTime[GLASS_13] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_13] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_14_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_14]) //_14锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_14] != SysTask.LockModeSave[GLASS_14])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_14] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_14] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_14_PIN);
					SysTask.Lock_StateTime[GLASS_14] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_14] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_14_PIN);
				SysTask.Lock_StateTime[GLASS_14] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_14] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_15_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_15]) //_15锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_15] != SysTask.LockModeSave[GLASS_15])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_15] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_15] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_15_PIN);
					SysTask.Lock_StateTime[GLASS_15] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_15] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_15_PIN);
				SysTask.Lock_StateTime[GLASS_15] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_15] = MOTO_STATE_INIT; //重新开始转动
			break;
...
void Lock_16_Task(void)
{
	...
	switch (SysTask.Lock_State[GLASS_16]) //_16锁
	{
		case LOCK_STATE_DETECT:
			if (SysTask.LockMode[GLASS_16] != SysTask.LockModeSave[GLASS_16])
			{
				...
				else 
				{
					...
					u8ClockCnt			= 0;
					u8ClockPer			= 0;
					SysTask.Lock_StateTime[GLASS_16] = SysTask.nTick + LOCK_SET_L_TIME;
					SysTask.Lock_State[GLASS_16] = LOCK_STATE_SENT;
				}
			}
		...
		case LOCK_STATE_SENT: //
			...
			if (u8ClockCnt < 4)
			{
				...
				if (u8ClockPer == 0)
				{
					u8ClockPer			= 1;
					GPIO_SetBits(LOCK_GPIO, LOCK_16_PIN);
					SysTask.Lock_StateTime[GLASS_16] = SysTask.nTick + LOCK_SET_H_TIME;
				}
				else 
				{
					u8ClockPer			= 0;
			...
			{
				SysTask.Lock_State[GLASS_16] = LOCK_STATE_OFF;
				GPIO_SetBits(LOCK_GPIO, LOCK_16_PIN);
				SysTask.Lock_StateTime[GLASS_16] = SysTask.nTick + LOCK_SET_OFF_TIME; //停止电平
		...
		case LOCK_STATE_OFF: //
			...
			//	点击了转动，这里让他转动起来
			SysTask.Moto_State[GLASS_16] = MOTO_STATE_INIT; //重新开始转动
			break;
